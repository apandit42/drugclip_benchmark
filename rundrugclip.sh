...
CUDA_VISIBLE_DEVICES="1" python -m torch.distributed.launch --use_env --nproc_per_node=$n_gpu --master_port=$MASTER_PORT $(which unicore-train) $data_path --user-dir ./unimol --train-subset train --valid-subset valid \
